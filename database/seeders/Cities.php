...
class Cities extends Seeder
{
    ...
    public function run()
    {
        $sql="INSERT INTO `cities` (`id`, `name`, `uf`, `ibge`) VALUES
        ...
        $sql2="INSERT INTO `cities` (`id`, `name`, `uf`, `ibge`) VALUES
        ...
        $sql3="INSERT INTO `cities` (`id`, `name`, `uf`, `ibge`) VALUES
        ...
        $sql4=" INSERT INTO `cities` (`id`, `name`, `uf`, `ibge`) VALUES
